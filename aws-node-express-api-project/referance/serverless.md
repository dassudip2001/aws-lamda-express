...
```json
{
  ...
  "Statement": [
    ...
    },
    {
      ...
      "Resource": ["arn:aws:cloudformation:*:AWS_ID:stack/serverless-*"]
    },
    {
      "Effect": "Allow",
      "Action": [
    ...
    },
    {
      ...
      "Resource": ["arn:aws:s3:::serverless-*serverlessdeploy*"]
    },
    {
      "Effect": "Allow",
    ...
    },
    {
      ...
      "Resource": ["arn:aws:lambda:*:AWS_ID:function:serverless-*"]
    },
    {
      "Effect": "Allow",
    ...
    },
    {
      ...
      "Resource": ["arn:aws:events:*:AWS_ID:rule/serverless-*"]
    },
    {
      "Effect": "Allow",
    ...
    },
    {
      "Effect": "Allow",
      "Action": ["iam:PassRole"],
      "Resource": ["arn:aws:iam::AWS_ID:role/serverless-*"]
    },
    {
      "Effect": "Allow",
      "Action": [
